...
import numpy as np
from DipoleModule import Dipole, PlateHeatExchangerSide, Pole
from math import pi
...
class HeatExchanger:
    ...
    Attributes:
        ...
        correctingThermicCoefficient(type:float or :obj:np.float64): 
            It represents the coefficient F in the formula :
                Q = F K S DTLM
            where:
                - K is the global thermal coefficient
                - Q is the thermal power exchanged
                - S is the exchange surface 
                - DTLM is average logithmic difference between the 2 flows.
            It's equal to 1.0 for countercurrent flow
    ...
    def __init__(self,name = 'heat exchanger', materialConductivity = 21.9,exchangeSurface = 600, 
                ...
                correctingThermicCoefficient = 1.0, correlations = False,
        ...
        typeErrorAtEntering(correctingThermicCoefficient, message = "the correctingThermicCoefficient must be a float or a None type")

        typeErrorAtEntering(exchangeSurface,Types = [bool], Classes = [], message = "the correlations must be a boolean or a None type")

        self.__correctingThermicCoefficient = correctingThermicCoefficient
        ...
        self.__stateEquations = None
        self.__correlations = correlations
    
    @property 
    def correlations(self): 
        """ get method and set method to access the private variable correlations """
    ...
    @property 
    def correctingThermicCoefficient(self): 
        """ get method and set method to access the private variable correctingThermicCoefficient """
        return self.__correctingThermicCoefficient

    @correctingThermicCoefficient.setter 
    def correctingThermicCoefficient(self,correctingThermicCoefficient): 
        typeErrorAtEntering(correctingThermicCoefficient, message = "the correctingThermicCoefficient must be a float or a None type")
        self.__correctingThermicCoefficient = correctingThermicCoefficient
    ...
    def hydraulicDipoleCold(self,hydraulicDipoleCold): 
        typeErrorAtEntering(hydraulicDipoleCold,Types = [], Classes = [Dipole], message = "the hydraulic dipole Cold must be a dipole")
        hydraulicDipoleCold.exchanger = True
        self.__hydraulicDipoleCold = hydraulicDipoleCold
    ...
    @stateEquations.setter 
    def stateEquations(self,stateEquations): 
    ...
    def stateEquationDefinition(self, averagePressureCold = None, averagePressureWarm = None, modify = True):
        ...
        def constructor():
            ...
            if not self.correlations :
                def K(flowRateCold, meanTemperatureCold, flowRateWarm, meanTemperatureWarm):
                    return exchanger.thermicTransfertCoefficient()
                return K
            def K(flowRateCold, meanTemperatureCold, flowRateWarm, meanTemperatureWarm):
            ...
            return K
        K = constructor()
        correctingThermicCoefficient = self.correctingThermicCoefficient
        ...
        """
            ...
            #the DTLM equation
            DTLMequation = meanEnergy / globalThermicTransfertCoefficient / exchangeSurface / correctingThermicCoefficient \
        ...
        def newEquations(X):
            ...
            for i in range(N):
                if variables[i]:
                    ...
                    Y[i] = Variables[i]
            return stateEquations(Y[0],Y[1],Y[2],Y[3],Y[4],Y[5])
    ...
    def thermicTransfertCoefficient(self, reynoldsNumberCold = None, prandtlNumberCold = None,
                                                                    thermicConductivityCold = None, 
                                                                    reynoldsNumberWarm = None, prandtlNumberWarm = None,
                                                                    thermicConductivityWarm = None):
        ...
        args:
            the args to call the function in the stateEquations.
        ...
        return self.globalThermicCoefficient
...
class PlateExchanger(HeatExchanger):
    ...
    def __init__(self, name = 'plate heat exchanger', materialConductivity = 21.9,hydraulicDipoleCold = None, 
                ...
                downstreamPoleCold = Pole('downstreamPoleCold'), upstreamPoleCold = Pole('upstreamPoleCold'), 
                downstreamPoleWarm = Pole('downstreamPoleWarm'), upstreamPoleWarm = Pole('upstreamPoleWarm'), 
                flowCold = Flow(), flowWarm = Flow(), correctingThermicCoefficient = 1.0) : 
        ...
        HeatExchanger.__init__(self, name = name, materialConductivity = materialConductivity,
                              ...
                              correctingThermicCoefficient = correctingThermicCoefficient, correlations = True)
